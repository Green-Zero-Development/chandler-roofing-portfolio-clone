    ...
    return (
        ...
        <Hero>
            <div className="wrapper">
                <Image src={pageData.acf.hero.background_image.url} alt={pageData.acf.hero.background_image.alt} fill style={{ objectFit: 'cover' }} placeholder="blur" blurDataURL={pageData.acf.hero.background_image.sizes.thumbnail} />
        ...
        <WhyUs>
            <div className="wrapper">
                <div className="image">
                    <Image src={pageData.acf.why_us.image.url} alt={pageData.acf.why_us.image.alt} fill style={{ objectFit: 'cover' }} placeholder="blur" blurDataURL={pageData.acf.why_us.image.sizes.thumbnail} />
                </div>
                <div className="content">
        ...
        <ProjectsCta>
            <div className="wrapper">
                ...
                <div className="image">
                    <Image src={pageData.acf.projects.image.url} alt={pageData.acf.projects.image.alt} fill style={{ objectFit: 'cover' }} placeholder="blur" blurDataURL={pageData.acf.projects.image.sizes.thumbnail} />
                </div>
            </div>
        </ProjectsCta>
        </>
